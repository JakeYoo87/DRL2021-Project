...
from nasbench101_method import random_search, regularized_evolution

parser = argparse.ArgumentParser()
parser.add_argument('--run_iter', default=100, type=int, nargs='?', help='unique number to identify this run')
parser.add_argument('--run_method', default="re", type=str)
...
save_file = '%s_iter%d.txt' % (args.run_method, args.run_iter)
